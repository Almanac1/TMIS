"""
Django settings for TMIS project.
...
def _load_env_file(path: Path, allowed_keys=None):
    if not path.exists():
        return
...
SECRET_KEY = os.getenv(
    "SECRET_KEY",
    "django-insecure-8xtm#bb@b7!!_l9t=-b^1!_)=t^!%!s^qzku&9-gkm-i*i(z)a",
)
...
WSGI_APPLICATION = 'TMIS.wsgi.application'
