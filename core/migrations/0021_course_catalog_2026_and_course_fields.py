...
def seed_official_courses(apps, schema_editor):
    ...
    official_courses = [
        ...
        },
        {
            ...
            "variant": "Family",
            "base_fee": Decimal("4500.00"),
            "additional_cost_description": "₦750 per child under 18.",
            "requires_residence": False,
            "notes": "Official 2026 MFG Services course.",
        },
        {
        ...
        },
        {
            ...
            "additional_cost_description": "₦100/day for meals.",
            "requires_residence": False,
            "notes": "Official 2026 MFG Services course.",
        },
        {
            ...
            "additional_cost_description": "₦100/day for meals per person if applicable.",
            "requires_residence": False,
            "notes": "Official 2026 MFG Services course.",
        },
        {
